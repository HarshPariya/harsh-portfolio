...
export const H1: React.FC<HeadingProps<"h1">> = ({ children, variant = "large", ...rest }) => {
  const variants = {
    large: "xs:text-5xl relative z-5 text-4xl leading-[1] font-medium tracking-tight text-stone-900 sm:text-6xl lg:text-7xl",
    medium: "sm:text-3xl relative z-5 text-3xl leading-[1.1] font-normal tracking-tight text-stone-800 sm:text-4xl lg:text-5xl",
  }
...
export const H2: React.FC<HeadingProps<"h2">> = ({ children, ...rest }) => {
  return (
    <h2 {...rest} className={clsx("text-4xl tracking-tighter text-stone-800 md:text-5xl md:leading-11 lg:text-6xl lg:leading-15", rest.className)}>
      {children}
    </h2>
  )
}
...
export const H3: React.FC<HeadingProps<"h3">> = ({ children, ...rest }) => {
  return (
    <h3 {...rest} className={clsx("text-2xl leading-8 font-medium tracking-tight text-stone-800 md:text-3xl", rest.className)}>
      {children}
    </h3>
  )
}
...
export function Text({ as: Component = "p", size = "base", className = "", ...props }: TextProps) {
  ...
  return <Component {...props} className={`${sizeClasses[size]} tracking-tight text-stone-500 ${className}`} />
}
...
export function Typography({ as: Component = "article", size = "base", ...props }: TypographyProps) {
  ...
  return <Component {...props} className={`text-stone-500 ${sizeClasses[size]} ${props.className}`} />
}
